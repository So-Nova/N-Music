...
@Client.on_message(command(["gban","حظر","gban@{bn}"]) & other_filters)
@bot_creator
        ...
        if user.id == from_user.id:
            ...
            for num in served_chats:
                try:
                    ...
                    pass
            ban_text = f"""
**⌯ تم حظر المستخدم :** {mention}
**⌯ بواسطه المطور :** {from_user_mention}
**⌯ و تم حظره في :** {number_of_chats} مجموعات"""
            try:
                await m.delete()
            except Exception:
                pass
...
**⌯ تم حظر المستخدم :** {mention}
**⌯ بواسطه المطور :** {from_user_mention}
**⌯ و تم حظره في :** {number_of_chats} مجموعه"""
            try:
                await m.delete()
            except Exception:
                pass
...
@Client.on_message(command(["ungban","لغاء الحظر","ungban@{bn}"]) & other_filters)
@bot_creator
            ...
            if not is_gbanned:
                ...
                for num in served_chats:
                    try:
                        ...
                        pass
                await msg.edit_text("⌯ تم الغاء الحظر العام من المجوعات .")
        return
    from_user_id = message.from_user.id
    user_id = message.reply_to_message.from_user.id
    mention = message.reply_to_message.from_user.mention
